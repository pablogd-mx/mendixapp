...
public class TrainingEvent
{
	...
	public enum MemberNames
	{
		...
		TrainingEvent_Teachers("MyFirstModule.TrainingEvent_Teachers");
	...
	/**
	 * @return value of TrainingEvent_Teachers
	 */
	public final myfirstmodule.proxies.Teachers getTrainingEvent_Teachers() throws com.mendix.core.CoreException
	{
		return getTrainingEvent_Teachers(getContext());
	}
	 ...
	 * @return value of TrainingEvent_Teachers
	 */
	public final myfirstmodule.proxies.Teachers getTrainingEvent_Teachers(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		myfirstmodule.proxies.Teachers result = null;
		com.mendix.systemwideinterfaces.core.IMendixIdentifier identifier = getMendixObject().getValue(context, MemberNames.TrainingEvent_Teachers.toString());
		if (identifier != null)
			result = myfirstmodule.proxies.Teachers.load(context, identifier);
		return result;
	}

	/**
	 * Set value of TrainingEvent_Teachers
	 * @param trainingevent_teachers
	 */
	public final void setTrainingEvent_Teachers(myfirstmodule.proxies.Teachers trainingevent_teachers)
	{
		setTrainingEvent_Teachers(getContext(), trainingevent_teachers);
	}
	 ...
	 * @param trainingevent_teachers
	 */
	public final void setTrainingEvent_Teachers(com.mendix.systemwideinterfaces.core.IContext context, myfirstmodule.proxies.Teachers trainingevent_teachers)
	{
		if (trainingevent_teachers == null)
			getMendixObject().setValue(context, MemberNames.TrainingEvent_Teachers.toString(), null);
		else
			getMendixObject().setValue(context, MemberNames.TrainingEvent_Teachers.toString(), trainingevent_teachers.getMendixObject().getId());
	}
